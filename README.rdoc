...
I happen to be using Heroku. Here's how you'd deploy there:
 ...
 heroku config:add CHEF_OPENID_URL=https://curried-emu-12.heroku.com
 heroku config:add CHEF_VALIDATION_TOKEN=73feffa4b7f6bb68e44cf984c85f6e88
 heroku addons:add piggyback_ssl
 git push heroku master

Then, assuming your app lives at "curried-emu-12", give it a go with

 open https://curried-emu-12.heroku.com
