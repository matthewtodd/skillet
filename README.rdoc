...
It would be great if Heroku supported git submodules. (See http://docs.heroku.com/constraints#git-submodules.) Then we could pull in git://github.com/opscode/cookbooks as cookbooks and our own as site-cookbooks, without duplication.
