...
It would be great if Heroku supported git submodules. (See http://docs.heroku.com/constraints#git-submodules and http://groups.google.com/group/heroku/browse_thread/thread/5e6807fcd2572f64/bee1a3b581db9c00.) Then we could pull in git://github.com/opscode/cookbooks instead of duplicating it.

I've made a few patches: see config/init.rb and slices/chef-server-slice.
...
With any luck, they'll be included in the 0.7.6 release! It will be nice, from a cognitive accessibility standpoint, to whack the slices directory as well as the Chef::REST monkey patch in init.rb.
